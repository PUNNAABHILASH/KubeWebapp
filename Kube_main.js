function launch_pod(){
  ...
  form_i.action = "http://192.168.0.29/cgi-bin/launch_pod.py"
  form_i.id = "f";
...
function launch_deployment(){
  ...
  form_i = document.createElement("form");
  form_i.action = "http://192.168.0.29/cgi-bin/launch_deployment.py"
  form_i.id = "f";
...
function scale_deployment(){
  ...
  form_i = document.createElement("form");
  form_i.action = "http://192.168.0.29/cgi-bin/scale_deployment.py"
  form_i.id = "f";
...
function create_service(){
  ...
  form_i = document.createElement("form");
  form_i.action = "http://192.168.0.29/cgi-bin/create_service.py"
  form_i.id = "f";
...
function Delete(){
  ...
  form_i = document.createElement("form");
  form_i.action = "http://192.168.0.29/cgi-bin/delete.py"
  form_i.id = "f";
...
function run_command(){
 ...
 var queryString = "http://192.168.0.29/cgi-bin/command.py?cmd=" + command;
...
function interact(){
 ...
 recog.onresult = function(event){
                 ...
                 var queryString = "http://192.168.0.29/cgi-bin/interact.py?cmd=" + transcript;
                 xhr.open("GET", queryString, true);
                 xhr.send();
                 xhr.onload = function(){
                   var output = xhr.responseText;
